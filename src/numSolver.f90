...
module numDiag 
  ...
  real(rk)    :: TSolEnergBalVeg, TSolEnergBalNoVeg
  ...
  subroutine printEnergBalDiag()
    ...
    print *,  "TSolEnergBalVeg (K)   = "//trim(dou2str(TSolEnergBalVeg))//"; TSolEnergBalNoVeg (K) = "//trim(dou2str(TSolEnergBalNoVeg))//";"
